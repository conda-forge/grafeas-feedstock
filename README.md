...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/grafeas-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9611&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/grafeas-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `grafeas` can be installed with:

```
conda install grafeas
```

It is possible to list all of the versions of `grafeas` available on your platform with:
